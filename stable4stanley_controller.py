...
def main():
    ...
    k_e = 4.0     # Stanley gain for cross-track error
    dt = 0.1      # Time step
    L = 1.0       # Wheelbase
    ...
    waypoint_reach_threshold = 1.0  # meters (smaller than before)
...
def simulate(waypoints, x, y, yaw, v, target_idx, k, k_e, target_speed, dt, L, max_steer,
    ...
    with open('debug_output.txt', 'w') as f:
        ...
        for i in range(max_iter):
            ...
            # More aggressive speed reduction at sharp turns
            if abs(delta) > np.radians(30):
                current_target_speed = target_speed * 0.3  # Slow down more
